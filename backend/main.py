"""
SalesScope 3 - Backend API
Sales performance dashboard with pipeline view, forecasting, and team leaderboard
"""
...
app = FastAPI(
    title="SalesScope 3",
    description="Sales performance dashboard with pipeline view, forecasting, and team leaderboard",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "SalesScope 3"}
